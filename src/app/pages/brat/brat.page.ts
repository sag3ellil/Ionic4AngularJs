...
@Component({
  selector: 'app-brat',
  templateUrl: './brat.page.html',
  styleUrls: ['./brat.page.scss'],
})
export class BratPage implements OnInit {
...
this.dd2=item
 ...
 console.log("form",form.value);
 this.Authorizer.QueryStoreProcNgFormExec('executeBouraoui',"spConsultasBratIonic","DataJson", params2).then(res => {
    let resultado: any = res;
    try {
      if (resultado.length == 0) {
        //nenhum modulo encontrado
